...
# 定义 -> 核心变量
my $gsea                = "/home/genesky/software/gsea/3.0/gsea-3.0.jar";
my $java8               = "/home/genesky/software/java/1.8.0_181/bin/java";
...
# (3) GSEA 分析
system("$java8 -cp $gsea xtools.gsea.Gsea -gmx $hashDB{$database} -collapse false -res $gct_file  -cls $cls_file -set_min  $min_gene_count -metric $metric_para  -out $output_dir -rpt_label GSEA");
...
sub database_list{
    ...
    $hashDB{'Human_KEGG'} = "/home/genesky/database/gsea/human/c2.cp.kegg.v6.2.symbols.gmt";
