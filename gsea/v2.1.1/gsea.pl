...
# 定义 -> 核心变量
my $gsea                = "/home/genesky/software/gsea/4.1.0/gsea-cli.sh";
...
sub database_list{
    ...
    $hashDB{'Human_KEGG'} = "/home/genesky/database/gsea/human/c2.cp.kegg.v7.1.symbols.gmt";
...
Options:
    ...
    [选填]
         --gmt_file           自定义GSEA富集分析数据库文件路径， gmt格式。
