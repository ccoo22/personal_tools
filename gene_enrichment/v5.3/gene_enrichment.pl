...
# 软件、环境设置
my $Rscript         = "/home/genesky/software/r/4.2.2/bin/Rscript";
my $Rlib            = "/home/genesky/software/r/4.2.2/lib64/R/library";
...
system("mv $output_dir/kegg_heatmap.pdf $custom_figure_dir/") if(-e "$output_dir/kegg_heatmap.pdf");
system("mv $output_dir/do_dotplot.pdf $custom_figure_dir/") if($species eq "Homo_sapiens");

# 获取P<0.05通路图下载地址，并上色, 升级版，应对IP被禁
system("perl $kegg_pathway_download -k $kegg_raw -c $gene_list -o $output_dir/KEGG_Pathway_Illustrations");
