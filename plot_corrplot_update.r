...
"Usage: plot_corrplot.r  -i <file> -o <pdf file> [--cor_direction <string> --cor_method <string>  --width <int>   --height <int> --item_color <string> --pvalue_cutoff <numeric> --title <string> --shape <string> --show_type <string> --order_item <string>  --show_coef_value <color>  --rlib <dir>]
...
result_estimate = data.frame(id = rownames(corr), corr, check.names=F)
result_pvalue = data.frame(id = rownames(p.mat), p.mat, check.names=F)
