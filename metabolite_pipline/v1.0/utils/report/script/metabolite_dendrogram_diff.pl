...
{   
    ...
    {
        print "[Error] in dendrogram diff_model, lost $diff_compound_id [$group_list][$sub_compare_name]\n";
    ...
    {   
        ...
        {   # 聚类计算方法
            ...
            {   
                my $dendrogram = "$input/$sub_compare_name/dendrogram_$distance_method\_$cluster_method.diff_compound.pdf";
