...
{   
    ...
    {
        print "[Error] in PCA diff_model, lost $diff_compound_id [$group_list][$sub_compare_name]\n";
    ...
    {
        my $pca            = "$input/$sub_compare_name/pca.diff_compound.pdf";
        my $pca_biplot     = "$input/$sub_compare_name/pca_biplot.diff_compound.pdf";
        my $pca_coordinate = "$input/$sub_compare_name/pca_coordinate.diff_compound.csv";
