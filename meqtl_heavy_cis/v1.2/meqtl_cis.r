...
library(docopt)
"Usage: meqtl_cis.r --output <file> --exp_file <file> --exp_loc_file <file> --snv_file <file> --snv_loc_file <file>  [--cor_file <file> --cisdist <string> --cis_p <string> --rlib <dir> --thread <int> --exp_anno <file> --snp_anno <file>]
Options:
