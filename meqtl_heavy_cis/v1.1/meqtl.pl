...
my ($snp_file, $exp_file, $sample_file, $output_dir, $cis_distance, $cis_pvalue, $report_pvalue, $snp_add_col, $exp_add_col, $anno_thread, $boxplot_top, $plot_y_lab, $SOFT_RSCRIPT, $SOFT_RLIB, $if_help);
GetOptions(
