...
library(docopt)
"Usage: barplot.r  -i <file> --pdf <file> --sample_group <file> [--add_mark <file>  --width <int> --height <int> --legend_pos <string> --title <string> --position_dodge_value <numeric> --rotate_x_text <numeric> ]
Options:
...
# p <- ggviolin(data_plot, x="feature_name", y="Value", fill = "Group", 
...
p<-ggplot(data_plot, aes(x = feature_name, y = Value)) + geom_violin(aes(fill = Group), width=0.2, size=0.2, position=position_dodge(1)) 
